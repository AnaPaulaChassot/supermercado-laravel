...
Route::get('/foto-produtos/show/{id}',[FotoProdutoController::class, 'show']);
...
Route::get('/cidades/show/{id}',[CidadeController::class, 'show']);
...
Route::get('/usuarios/show/{id}',[UsuarioController::class, 'show'])->name('usu.show');
